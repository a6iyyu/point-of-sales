...
<form action="{{ url('/penjualan/store-ajax') }}" method="POST" id="form-tambah">
    @csrf
                ...
                <div class="form-group">
                    ...
                    <div id="barang-wrapper">
                        <div class="form-row mb-2 barang-row">
                            ...
                            <div class="col-2">
                                <input type="number" name="stok[]" id="stok" class="form-control stok" placeholder="Stok" readonly required>
                            </div>
                            <div class="col-2">
                                <input type="number" name="harga[]" id="harga" class="form-control input-harga" placeholder="Harga" min="0" readonly required>
                            </div>
                            <div class="col-2">
                    ...
                    <div class="form-row mb-2 justify-content-end">
                        ...
                        <div class="col-5">
                            <div class="form-control bg-light text-right" id="total-harga"></div>
                        </div>
...
<script>
    ...
    $('#tambah-barang').click(function () {
        ...
        if (!semuaTerisi) {
            Swal.fire({
                icon: 'warning',
                title: 'Lengkapi Data',
                text: 'Harap isi semua bidang Barang, Harga, dan Jumlah sebelum menambah barang baru.'
            });
            return;
        }

        const clone = $('.barang-row').first().clone();
    ...
    $(document).on('input', 'input[name="jumlah[]"]', () => updateTotal());
    ...
    $(document).on('change', '.select-barang', function () {
        ...
        console.log('barang dipilih:', { stok, harga });
